defmodule Seraph.Schema.Node do
  ...
  defmacro __using__(_) do
    quote do
      ...
      Module.register_attribute(__MODULE__, :autogenerate, accumulate: true)
      Module.register_attribute(__MODULE__, :autoupdate, accumulate: true)
    end
  end
  ...
  defmacro node(primary_label, do: block) do
    ...
    postlude =
      quote unquote: false do
        ...
        def __schema__(:autogenerate), do: Enum.reverse(@autogenerate)
        def __schema__(:autoupdate), do: Enum.reverse(@autoupdate)
  ...
  * `relationship_module` - Defines the Relationship module
  ...
  @doc """
  Generates `:createdAt` and `:updatedAt` timestamp fields.
  ...
  ## Options
    ...
    * `:createdAt` - the Ecto schema name of the field for insertion times or `false`
    * `:updatedAt` - the Ecto schema name of the field for update times or `false`
  ...
  defmacro timestamps(opts \\ []) do
    quote bind_quoted: binding() do
      ...
      type = Keyword.get(timestamps, :type, :utc_datetime_usec)
      autogen = timestamps[:autogenerate] || {Seraph.Schema.Node, :__timestamps__, [type]}

      createdAt = Keyword.get(timestamps, :createdAt, :createdAt)
