defmodule Neo4jex.Query.Planner do
  @spec query(Neo4jex.Repo.t(), String.t(), map, Keyword.t()) :: {:ok, list | map} | {:error, any}
  ...
  @spec query!(Neo4jex.Repo.t(), String.t(), map, Keyword.t()) :: list | map
  def query!(repo, statement, params \\ %{}, opts \\ []) do
  ...
  @doc false
  @spec raw_query(Neo4jex.Repo.t(), String.t(), map, Keyword.t()) ::
